        ...
        <div class="about__content">
            ...
            <div class="about__desc">
                <div class="about__visible">
                    <p class="about__text">
                        Мы рады приветствовать вас на нашем сайте. Здесь вы можете ознакомиться с перечнем услуг, предоставляемых командой профессионалов ветеринарной клиники "Мален-Вет". Еще вашему вниманию предлагаем полезные <a href="articles.html" class="about__link-text">статьи</a>.
                    </p>
                    <p class="about__text">
                        Клиника оснащена современным оборудованием, а также сотрудничает с рядом лабораторий, что позволяет делать все виды анализов и производить любую <a href="diagnostic.html" class="about__link-text">диагностику</a>.
                    </p>
                    <p class="about__text">
                        Тут вы можете получить консультацию по выращиванию, содержанию и уходу за вашим питомцем.
                    </p>
                    <p class="about__text">
                        Наши врачи имеют достаточно практического опыта в постановке диагноза и назначении <a href="therapy.html" class="about__link-text">терапии</a>.
                    </p>
                    <p class="about__text">
                        Специалист <a href="dentistry.html" class="about__link-text">стоматолог</a> поможет сохранить зубы вашего питомца здоровыми и красивыми.
                    </p>
                    <p class="about__text">
                        Квалификация <a href="surgery.html" class="about__link-text">хирургов</a> позволяет проводить операции любой степени сложности.
                    </p>
                    <p class="about__text">
                        Для пациентов, нуждающихся в постоянном присмотре ветеринарного врача, функционирует <a href="hospital.html" class="about__link-text">стационар</a>.
                    </p>
                    <p class="about__text">
                        Работает <a href="gruming.html" class="about__link-text">груминг</a> кабинет.
                    </p>
                    <p class="about__text">
                        Мы ценим ваш комфорт и время. Поэтому у нас есть <a href="contacts.html" class="about__link-text">предварительная запись</a>. Это позволяет клиентам заранее планировать свой график и не тратить время на ожидание в очереди.
                    </p>
                    <div class="about__more">
                        <div class="about__read">
                            ...
                            <p class="about__text">
                                Комната ожидания приема оборудована кулером со свежей питьевой водой, здесь же находится <a href="shop.html" class="about__link-text">зоомагазин</a>, где можно приобрести необходимые товары для животных.
                            </p>
                            <p class="about__text">
                                В приемной есть весы, на которых можно взвесить питомцев от размера маленького котенка до размера большой собаки, <a href="pharmacy.html" class="about__link-text">ветеринарная аптека</a>, бесплатный Wi-Fi.
                            </p>
                            <p class="about__text">
                                Если вам нужно оставить клинически здоровое животное на время вашего отъезда – это можно сделать в <a href="hospital.html" class="about__link-text">гостинице</a> при клинике. Профессиональный уход и безопасность обеспечены.
                            </p>
                        </div>
                    </div>
